...
//       const data = await handleGetProductById(
//         productId
//       );
...
//     const cleanedAttributes = attributes.map(
//       (attr) => ({
//         ...attr,
...
//             <p className="text-3xl font-bold text-violet-600 mt-5">
//               ₹
//               {product?.price?.amount ||
//                 product?.price}
//             </p>
...
//             className="w-full mt-6 bg-violet-600 text-white py-4 rounded-2xl flex items-center justify-center gap-2"
//           >
...
//               <p className="text-gray-500 mt-1">
//                 Edit price, stock, SKU and images
//               </p>
...
//                     <label className="w-12 h-12 rounded-2xl border border-dashed flex items-center justify-center cursor-pointer">
