            ...
            >
                ...
                <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#f5f3f0' }}>
                    <img
                        ...
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJOvZE1BxKtqLK4HF6bX2sFYiNheX0IOGcfA&s"
                ...
                >
                    <div className="w-full max-w-sm">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-9">
                            ...
                            className='text-sm text-[#e5e2e1] cursor-pointer group-hover:text-[#FFD700] select-none transition-colors duration-300'
